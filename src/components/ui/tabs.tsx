...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md border border-[var(--tf-border)] bg-[var(--tf-surface)] p-1 text-[var(--tf-text-primary)]',
      className,
    )}
    {...props}
  />
