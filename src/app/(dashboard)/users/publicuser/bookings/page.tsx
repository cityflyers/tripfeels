...
export default function UserBookingsPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full min-h-screen">
      ...
      <div className="w-full bg-[var(--tf-surface)] border-b border-[var(--tf-border)] sticky top-0 z-10">
      ...
      {/* Main content */}
      <main className="flex-1 w-full bg-gray-50 dark:bg-neutral-900">
        <div className="w-full px-4 md:px-6 py-6">
          ...
          {activeTab === 1 && (
            <div className="bg-[var(--tf-surface)] rounded-lg border border-[var(--tf-border)] p-6">
