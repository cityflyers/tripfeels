        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <input
              ...
              className="h-9 w-full sm:w-64 rounded-lg border border-white/30 bg-white/20 backdrop-blur-sm px-3 text-sm text-[var(--tf-text-primary)] placeholder:text-[var(--tf-text-muted)]"
              value={search}
            ...
            {isLoading && filteredUsers.length > 0 && (
              <div className="absolute inset-0 bg-white/50 dark:bg-black/50 backdrop-blur-sm z-10 flex items-center justify-center rounded-xl">
                <div className="flex items-center space-x-2 bg-white/80 dark:bg-gray-800/80 px-4 py-2 rounded-lg shadow-lg">
                  ...
                  <span className="text-sm text-[var(--tf-text-secondary)]">Loading...</span>
                </div>
              </div>
            )}
                ...
                {filteredUsers.map((user, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-[var(--tf-text-secondary)]">
          ...
          <div className="md:hidden space-y-4 overflow-visible relative z-0">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-lg font-semibold text-[var(--tf-text-primary)] truncate">
                            {fullName || 'Unnamed User'}
                          </h3>
                          <p className="text-sm text-[var(--tf-text-muted)] truncate">
                            {user.email}
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        {isExpanded ? (
                          <ChevronDown className="h-5 w-5 text-[var(--tf-text-secondary)]" />
                        ) : (
                          <ChevronRight className="h-5 w-5 text-[var(--tf-text-secondary)]" />
                        )}
                      </button>
                    </div>
                    ...
                    {/* Last Login Info */}
                    <div className="text-xs text-[var(--tf-text-muted)] mb-4">
                    ...
                    <div className="space-y-3 overflow-visible relative z-0">
                      <div>
                        <label className="block text-xs font-semibold text-[var(--tf-text-secondary)] mb-2 uppercase tracking-wide">
                          Role
                        </label>
                        <CustomDropdown
                    ...
                    <div className="px-6 pb-6 bg-gradient-to-br from-white/5 to-white/10 border-t border-white/10 overflow-visible relative z-0">
                      <div className="space-y-6">
                        <div className="flex justify-between items-center">
                          <h4 className="text-lg font-semibold text-[var(--tf-text-primary)]">
                            User Details
                          </h4>
                        ...
                        {isEditing ? (
                          <div className="space-y-6 overflow-visible relative z-0">
                            <div className="grid grid-cols-1 gap-4 overflow-visible relative z-0">
                              <div>
                                <label className="block text-sm font-semibold text-[var(--tf-text-secondary)] mb-2 uppercase tracking-wide">
                                  First Name
                                </label>
                                <input
                                  type="text"
                                  ...
                                  className="w-full px-3 py-2 rounded-lg border border-white/30 bg-white/20 backdrop-blur-sm text-[var(--tf-text-primary)] placeholder:text-[var(--tf-text-muted)]"
                            ...
                            <div className="flex gap-3">
                              ...
                              <button
                                ...
                                className="px-4 py-2 text-sm font-medium bg-gray-500/20 text-[var(--tf-text-secondary)] rounded-xl hover:bg-gray-500/30 transition-all duration-200 hover:shadow-lg"
                              >
                                Cancel
                              </button>
                            </div>
                          ...
                          <div className="space-y-4">
                            <div className="grid grid-cols-1 gap-4">
                              <div>
                                <label className="block text-xs font-semibold text-[var(--tf-text-muted)] mb-1 uppercase tracking-wide">
                                  First Name
                                </label>
            ...
            {filteredUsers.length === 0 && !isLoading && (
              <div className="p-6 bg-[var(--tf-surface)] backdrop-blur-md rounded-xl border border-[var(--tf-border)] shadow-lg text-center">
                <div className="text-sm text-[var(--tf-text-secondary)]">No users found.</div>
              </div>
            )}
          </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-3 py-2 text-sm font-medium bg-[var(--tf-surface)] backdrop-blur-sm border border-[var(--tf-border)] text-[var(--tf-text-primary)] rounded-lg hover:bg-white/30 dark:hover:bg-white/20 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
                      ...
                      <button
                        ...
                        className={`px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                          pageNum === currentPage
                            ...
                            : 'bg-[var(--tf-surface)] backdrop-blur-sm border border-[var(--tf-border)] text-[var(--tf-text-primary)] hover:bg-white/30 dark:hover:bg-white/20'
